  ...
  return (
    <header className="py-2 px-4 flex justify-center items-center border-b border-gray-200 bg-white sticky top-0 z-20 shadow-sm backdrop-blur-md bg-white/95">
      <div className="flex items-center gap-2.5">
        {/* Logo Image */}
        <img 
          src="https://cdwikwhttps://cdwikwwpakmlauiddasz.supabase.co/storage/v1/object/public/question-images/Gemini_Generated_Image_1dqfda1dqfda1dqf.pngwpakmlauiddasz.supabase.co/storage/v1/object/public/question-images/nuz9woyozo_1763176879951.png" 
          alt="SSC24x7 Logo" 
